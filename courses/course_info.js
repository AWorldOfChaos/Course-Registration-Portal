...
exports.course_info = async (req, res) => {
    ...
    try {
        ...
        const data  =  await client.query(`SELECT course.course_id, course.title, course.credits, section.building, section.room_number FROM course JOIN section ON course.course_id=section.course_id WHERE course.course_id=$1 and section.semester='Spring' and section.year=2010;`, [cID]);
